...
##################################################### solutions (userId, competiionId, solution, compiler, time, result, status)
exc("""drop table if exists solutions;""")
exc("""create table solutions (id int(11) auto_increment, userId int(11), competitionId int(11), solution varchar(10000), compiler varchar(40), time varchar(60), result varchar(40), status varchar(40), constraint solution_pk primary key (id)) CHARSET=utf8;""")
