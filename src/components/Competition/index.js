...
function Competition(props) {
  ...
  return (
    <CompetitionHeader {...props} menuItems={menuItems} render={(tab, setTab) =>
      <CompetitionContent {...props}  menuItems={menuItems} competition={competition} tab={tab} setTab={setTab} />}/>
  );
}
